...
// Comments
export const commentsSection = "border-t border-[#e8e8ed] mt-12 pt-8";
export const commentFormCard = "bg-[#f5f5f7] border border-[#e8e8ed] rounded-2xl p-5 mt-5";
export const commentTextarea =
  "w-full min-h-28 resize-y bg-white border border-[#d2d2d7] rounded-2xl px-4 py-3 text-[#1d1d1f] text-sm placeholder:text-[#a1a1a6] focus:outline-none focus:border-[#0066cc] focus:ring-2 focus:ring-[#0066cc]/10 transition";
export const commentList = "mt-8 flex flex-col gap-4";
export const commentItem = "border border-[#e8e8ed] rounded-2xl p-5 bg-white";
export const commentHeader = "flex items-center justify-between gap-3 mb-2";
export const commentAuthor = "text-sm font-semibold text-[#1d1d1f]";
export const commentText = "text-sm text-[#6e6e73] leading-7 whitespace-pre-line";
